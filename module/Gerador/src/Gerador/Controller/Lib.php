...
class Lib {
    ...
    public function wFile($file, $tmpl_data) {
        $handle = fopen($file, 'w') or die('Cannot write file:  ' . $file);
    ...
    public function generateRoutes($pathModule, $controller) {
        ...
        $config['controllers']['factories'][$modulo . '\Controller\\' . $controller . ''] = $modulo . '\Controller\Factory\\' . $controller . 'ControllerFactory';
